...
--
-- Table structure for table `tbl_um_membership`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_um_membership` (
  ...
  `out_card_code` varchar(30) NOT NULL DEFAULT '' COMMENT '外部会员卡号',
...
-- Dump completed on 2018-07-25 16:16:03
